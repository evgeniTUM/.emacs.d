...
For the most part there are no credits and links as this configuration
...
(define-key yas-minor-mode-map (kbd "TAB") nil)
(define-key yas-keymap (kbd "s-o") 'yas/next-field-or-maybe-expand)
(define-key yas-keymap (kbd "s-O") 'yas/prev-field)
   #+END_SRC
...
(defun evgeni/open-init-file ()
  "Opens the org-mode initialization file and starts header search"
  (interactive)
  (find-file (expand-file-name "~/.emacs.d/initialization.org"))
  (helm-org-headlines))
#+end_src
...
(defun evgeni/open-secrets-file ()
  "Opens the org-mode initialization file and starts header search"
  (interactive)
  (find-file (expand-file-name "~/shared/secrets.org.gpg"))
  (helm-org-headlines))
#+end_src
...
(bind-keys
 ...
 ("M-j" . ace-jump-mode)
 ("M-i" . jump-char-forward)
 ("M-I" . jump-char-backward)
...
(bind-keys :prefix "C-c m"
           ...
           ("m" . helm-enable-minor-mode)
           ("M" . helm-disable-minor-mode)
           ("g" . magit-status)
           ("e" . ebib)
           ("s" . eshell))
#+end_src
...
(add-hook 'hs-minor-mode-hook
          '(lambda ()
             (bind-key "<s-tab>" 'hs-toggle-hiding hs-minor-mode-map)
